  ...
  return (
    <Page className="flex flex-col gap-12">
      <section className="flex flex-col gap-6">
        ...
        {bucket === "test" && (
          <>
            <Text>
              ...
              experiment variants and show the resulting allocation. We leverage
              the{" "}
              <Link
              ...
              to pull Statsig configurations from the edge. As long as you have
              a bucket assigned you will always see the same result, otherwise
        ...
        <Text>Control button is red; Test button is blue.</Text>

        <Button
          size="lg"
          onClick={resetBucket}
          variant={bucket === "test" ? "black" : "primary"}
        >
          Reset {bucket} bucket
        </Button>
